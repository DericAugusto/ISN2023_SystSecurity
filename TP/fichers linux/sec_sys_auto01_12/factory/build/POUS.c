...
void PROGRAM2_init__(PROGRAM2 *data__, BOOL retain) {
  __INIT_VAR(data__->START_BUTTON,0,retain)
  __INIT_VAR(data__->LEVEL_SENSOR,0,retain)
  __INIT_VAR(data__->CONTACT_SENSOR,0,retain)
  __INIT_VAR(data__->MOTOR,0,retain)
  __INIT_VAR(data__->NOZZLE,0,retain)
  __INIT_VAR(data__->RUN,0,retain)
}
...
void PROGRAM2_body__(PROGRAM2 *data__) {
  ...
  __SET_VAR(data__->,RUN,,__GET_VAR(data__->START_BUTTON,));
  __SET_VAR(data__->,MOTOR,,((__GET_VAR(data__->LEVEL_SENSOR,) || !(__GET_VAR(data__->CONTACT_SENSOR,))) && __GET_VAR(data__->RUN,)));
  if ((((!(__GET_VAR(data__->CONTACT_SENSOR,)) && __GET_VAR(data__->RUN,)) && __GET_VAR(data__->LEVEL_SENSOR,)) && __GET_VAR(data__->RUN,))) {
    __SET_VAR(data__->,NOZZLE,,__BOOL_LITERAL(FALSE));
  };
  __SET_VAR(data__->,NOZZLE,,((!(__GET_VAR(data__->LEVEL_SENSOR,)) && __GET_VAR(data__->CONTACT_SENSOR,)) && __GET_VAR(data__->RUN,)));
  if (((!(__GET_VAR(data__->LEVEL_SENSOR,)) && __GET_VAR(data__->CONTACT_SENSOR,)) && __GET_VAR(data__->RUN,))) {
